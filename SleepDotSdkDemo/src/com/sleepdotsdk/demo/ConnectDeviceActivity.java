...
public class ConnectDeviceActivity extends BaseActivity {
    ...
    private static final String[] DEVICE_CODE = new String[]{
    		DeviceCode.DOT_10_0,//(普通枕扣)
    		DeviceCode.DOT_16_0,//(枕扣 B501-2)
    		DeviceCode.DOT_17_0,//(枕扣 B502T，有温湿度)
    };
    ...
    public void onClick(View v) {
    	...
    	if(v == tvDeviceCode){
        	...
        	if(!TextUtils.isEmpty(uid)){
        		...
        		sleepDotHelper.login(device.getDeviceName(), device.getAddress(), deviceCode, userId, 10 * 1000, new IDataCallback<LoginBean>() {
					@Override
